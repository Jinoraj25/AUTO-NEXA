  ...
  mapRow(rawPartNo, description, brandInput = "") {
    ...
    if (descUpper || brandUpper) {
      const phraseRules = [
        ...
        { pattern: /\bGASKET\s*MAKER\b|\bSEALANT\b/, agg: "PAINTS AND CONSUMABLES", subAgg: "CONSUMABLES", comp: "GASKET MAKER / SEALANT", cat: "Consumables" },
        ...
        { pattern: /\bBRAKE\s*DISC\b|\bROTOR\b/, agg: "BRAKE SYSTEM", subAgg: "BRAKE DISC", comp: "BRAKE DISC", cat: "Mechanical Parts" },
        ...
        { pattern: /\bSTRUT\s*KIT\b|\bBUMP\s*STOPPER\b/, agg: "SUSPENSION", subAgg: "STRUT KIT", comp: "BUMP STOPPER / STRUT KIT", cat: "Mechanical Parts" },
        { pattern: /\bSTEERING\s*BOOT\b|\bSTEERING\s*BELLOW\b/, agg: "STEERING", subAgg: "STEERING BOOT", comp: "STEERING BELLOWS / BOOT", cat: "Mechanical Parts" },
        { pattern: /\bUNIVERSAL\s*JOINT\b|\bU\s*JOINT\b|\bUJ\s*KIT\b/, agg: "TRANSMISSION", subAgg: "UNIVERSAL JOINT", comp: "UNIVERSAL JOINT KIT", cat: "Mechanical Parts" },
        { pattern: /\bGEAR\s*LEVER\b|\bGEAR\s*SHIFT\b/, agg: "TRANSMISSION", subAgg: "GEAR SHIFT LEVER", comp: "GEAR SHIFT LEVER KIT", cat: "Mechanical Parts" },
        ...
        { pattern: /\bFOG\s*LAMP\b|\bFOG\s*LIGHT\b/, agg: "LIGHTING", subAgg: "FOG LAMP", comp: "FOG LAMP ASSY", cat: "Electrical Parts" },
        { pattern: /\bBULB\b|\bW5W\b|\bT10\b/, agg: "LIGHTING", subAgg: "BULBS", comp: "BULB", cat: "Electrical Parts" },
        { pattern: /\bLED\b/, agg: "LIGHTING", subAgg: "LED LAMP", comp: "LED LAMP", cat: "Electrical Parts" },
        { pattern: /\bFUEL\s*WATER\s*SEPARATOR\b|\bWATER\s*SEPARATOR\b/, agg: "FILTERS", subAgg: "FUEL FILTER", comp: "FUEL WATER SEPARATOR", cat: "Consumables" }
      ];
